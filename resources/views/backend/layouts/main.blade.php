<?php
    ...
    $avatar_yys = url('img/logo_alfalah.png');
    ...
    $nmr_unit = $userinfo['id_unit'];
    $nm_unit = DB::table('unit')
        ->where('id_unit','=', $nmr_unit)
        ->first()->nama_unit;
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="left_col scroll-view">
                        ...
                        <div class="profile clearfix">
                            <div class="profile_pic">
                                <img src="<?=$avatar_yys;?>" alt="..." class="img-circle profile_img">
                            </div>
                    ...
                    <div class="nav_menu">
                        <nav>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <span name="id_unit" value="{{ $userinfo['id_unit'] }}">{{$nm_unit}}</span>
                                    </a>
