<?php
	...
	$breadcrumb[1]['url'] = url('backend/koreksi-stok-ppdb');
?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <a href="<?=url('backend/koreksi-stok-ppdb/barang/popup-media/');?>" class="btn btn-success browse-bahan-baku" title="Browse">Browse</a>
                                    </div>
                                </div>
                            </div>
                        </div>
