<?php
	...
	$breadcrumb[1]['title'] = 'Statistik Unit';
...
@section('content')
    <div class="page-title">
        <div class="title_left">
            <h3>Statistik Penjualan Unit</h3>
        </div>
			...
			<div class="x_panel">
				<div class="x_content">
                    ...
                    <div class="table-responsive">
                        ...
                        <p>*) Penjualan tanpa penitipan kantin</p>
                    </div>

                    <!-- Grafik Penjualan -->
                <h3 class="text-center">Grafik Penjualan per Unit</h3>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        const labels = {!! json_encode(array_column($data, 'nama_unit')) !!};
        const salesData = [
            @foreach ($data as $row)
                {{ $row->total_penjualan }},
            @endforeach
