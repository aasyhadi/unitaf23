...
class BarangKoreksiController extends Controller
{
    /**
    ...
    {
        return view ('backend.barang-koreksi.index');
    }
    ...
    {
        //
		return view ('backend.barang-koreksi.update');
    }
    ...
    public function store(Request $request)
    {
		...
		if($data->save()){
			return Redirect::to('/backend/barang-koreksi')->with('success', "Data saved successfully")->with('mode', 'success');
		}
    ...
    public function show($id)
    {
		...
		if ($data->count() > 0){
			return view ('backend.barang-koreksi.view', ['data' => $data]);
		}
    }
    ...
    public function edit($id)
    {
		...
		if ($data->count() > 0){
			return view ('backend.barang-koreksi.update', ['data' => $data]);
		}
    }
	...
	public function datatable() {	
        ...
        return Datatables::of($data)
			->addColumn('action', function ($data) {
				...
				$url_edit = url('backend/barang-koreksi/'.$data->id.'/edit');
                $url = url('backend/barang-koreksi/'.$data->id);
                $url_harga = url('backend/barang-koreksi/harga/'.$data->id);
	...
	public function histori($id) {
		...
		return view ('backend.barang-koreksi.histori', ['data' => $data]);
	}   
